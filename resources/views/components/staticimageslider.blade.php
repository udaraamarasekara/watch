<div id="default-carousel-static"  x-init="initFlowbite()" class=" w-full  top-30 " data-carousel="static">
    ...
    @auth
    <button type="button" class="absolute top-0 left-0  md:left-60 z-30 flex items-center justify-center h-2/3 pt-10 md:pt-0 md:h-full px-4 cursor-default group " >
    ...
    @else
    <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-2/3 md:h-full px-4 pt-10 md:pt-0 group cursor-default" >
    ...
    @endauth
    <button type="button" class="absolute top-0 right-0 z-30 flex items-center justify-center h-2/3 md:h-full px-4 group pt-10 md:pt-0  cursor-default" >
