...
@if(session()->has('success'))
    <div x-data="{success:true}"  x-show="success"    class="w-1/3 h-1/7 top-10 left-70 z-50 fixed bg-green-100 border border-green-400 text-green-700 px-4 py-3  rounded" role="alert">
        <strong class="font-bold">Comment added</strong>
