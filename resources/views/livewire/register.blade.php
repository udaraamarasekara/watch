...
@section('content')
 <div x-data="{click:false}" class=" flex flex-col" >
    ...
    <div class="flex flex-wrap -mx-3 justify-center ">
        ...
        <input  id="inputcontact" x-ref="inputcontact" wire:model.blur="contact" @keyup="click=false" class="appearance-none block w-full bg-gray-200 text-gray-400 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-user-name" type="text" placeholder="1111111111">
        <p  x-show="click && $refs.inputcontact.value=='' && $refs.inputusername.value!='' && $refs.inputemail.value!=''  "  class="text-red-500 text-xs italic">Please fill out this field.</p>
          @error('contact')
            <p x-show="click && $refs.inputcontact.value!='' && $refs.inputusername.value!='' && $refs.inputemail.value!=''  "  class="text-red-500 text-xs italic">Existing email.</p>
           @enderror
        </div>
    ...
    <div class="flex flex-wrap -mx-3 justify-center ">
        ...
        <div class="w-full md:w-1/2 px-3">
            ...
            <p x-show="click && $refs.inputpassword.value!='' && $refs.inputcontact .value!=''&& $refs.inputpasswordconfirmation.value!=$refs.inputpassword.value  && ( $refs.inputpassword.value.match(/\d/) || $refs.inputpassword.value.length > 8) && $refs.inputusername.value!='' && $refs.inputemail.value!=''  "  class="text-red-500 text-xs italic">Password already taken.</p>
            @endif
        </div>
        <div class="w-full md:w-1/2 px-3">
        ...
        <p x-show="click && $refs.inputpasswordconfirmation.value=='' && $refs.inputcontact .value!=''&& $refs.inputusername.value!=''  " class="text-red-500 text-xs italic">Please fill out this field.</p>
        <p x-show="click  && $refs.inputpasswordconfirmation.value!='' && $refs.inputcontact .value!=''&& $refs.inputpasswordconfirmation.value!=$refs.inputpassword.value && $refs.inputusername.value!=''  && $refs.inputemail.value!='' " class="text-red-500 text-xs italic">Password and confirmation missmatch.</p>
