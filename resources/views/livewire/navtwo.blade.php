<div x-init="navtwoheight=$refs.navtwo.offsetHeight" x-ref="navtwo" class="w-full bg-yellow-700 md:h-20  z-50 flex md:flex-row flex-col top-20 fixed" >
    <ul class="md:w-1/3 px-1 w-full" wire:click="navigate('/ ')"> 
    ...
    <div class="md:my-1 mx-1 mt-2 ">
    <div class="md:h-full bg-gray-300 md:w-1 w-full h-1 "></div>
     </div>
    <ul class="md:w-1/3 px-1 w-full " wire:click="navigate('/allwatches')"> 
        <li class=" h-full pt-4 md:pt-7 justify-center text-center  text-white w-full hover:bg-red-950 hover:text-yellow-300 " >
