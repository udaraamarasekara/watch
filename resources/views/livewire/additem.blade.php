...
@section('content')
<div x-data="{click:false,uploading: false}" class=" flex flex-col"  x-on:livewire-upload-progress="uploading = true" x-on:livewire-upload-start="uploading = true" x-on:livewire-upload-finish="uploading = false">
    <div class="md:pl-60 w-full flex-wrap flex flex-row justify-center " > 
        ...
        <form wire:submit.prevent="addwatch" class="w-4/5 mt-40 mb-10">
            ...
            <div  class="flex flex-row mt-2 ml-3">
                <input wire:loading.attr="disabled" wire:target="coverimage" wire:target="otherphotos" x-bind:disabled="uploading" :class="uploading && 'disabled:opacity-70'"  wire:loading.class="disabled:opacity-70" type="submit" id="sbt" @click="click=true" value="Add watch"
